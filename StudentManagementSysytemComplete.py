def addstudent():
    def submitadd():
        ...
        try:
            ...
            con.commit()
            res = messagebox.askyesnocancel('Notifications','Id  {} Name{} Added succesfylly......and want to clean the form'.format(id,name),parent=addroot)
            if(res==True):
                idval.set('')
                nameval.set('')
                mobileval.set('')
    ...
    addroot.title('Student Management Sysytem')
...
##add button##
    ...
    submitbtn = Button(addroot,text='Submit',font=('roman',15,'bold'),bg= 'red',bd=5,width=20,activebackground="blue",activeforeground="white",command=submitadd)
...
def searchstudent():
    ...
    searchroot.title('Student Management Sysytem')
...
##add button##
    ...
    submitbtn = Button(searchroot,text='Submit',font=('roman',15,'bold'),bg= 'red',bd=5,width=20,activebackground="blue",activeforeground="white",command=search)
...
def deletestudent():
    ...
    con.commit()
    messagebox.showinfo('Notifications','Id {} deleted succesfully.....'.format(pp))
    strr = 'select *from studentdata1'
    mycursor.execute(strr)
    data=mycursor.fetchall()
    studenttable .delete(*studenttable.get_children())
...
def updatestudent():
    def update():
        ...
        con.commit()
        messagebox.showinfo('Notifications','Id {} modified succesfully...'.format(id),parent=updateroot)
        strr = 'select *from studentdata1'
        mycursor.execute(strr)
        data=mycursor.fetchall()
        studenttable.delete(*studenttable.get_children())
        ...
        updateroot.title('Student Management Sysytem')
    ...
    ##add button##
        ...
        submitbtn = Button(updateroot,text='Submit',font=('roman',15,'bold'),bg= 'red',bd=5,width=20,activebackground="blue",activeforeground="white",command=update)
...
def Connectdb():
    def submitdb():
        ...
        try:
            ...
            messagebox.showerror('Notification','Data is in correct please try again',parent=dbroot)
            return
        try:
            ...
            mycursor.execute(strr)
            strr='create table studentdata1(id int,name varchar(20),mobile varchar(12),email varchar(50),address varchar(100),gender varchar(15),dob varchar(50),date varchar(50),time varchar(50))'
            mycursor.execute(strr)
    ...
    passwordlabel = Label(dbroot,text = "Enter Passord :",bg="gold2",font=("times",20,'bold'),relief=GROOVE,borderwidth=3,width=13,anchor="w")
...
color = ['red','green','blue','yellow','gold2','gold1']
...
addbtn = Button(DataEntryFrame,text='1. Add student',width=20,font=('chikker',20,'bold'),bd=6,bg='skyblue3',activebackground="blue",relief=RIDGE,activeforeground="white",command=addstudent)
addbtn.pack(side=TOP,expand=True)

searchbtn = Button(DataEntryFrame,text='2. Search student',width=20,font=('chikker',20,'bold'),bd=6,bg='skyblue3',activebackground="blue",relief=RIDGE,activeforeground="white",command=searchstudent)
searchbtn.pack(side=TOP,expand=True)

deletebtn = Button(DataEntryFrame,text='3. Delete student',width=20,font=('chikker',20,'bold'),bd=6,bg='skyblue3',activebackground="blue",relief=RIDGE,activeforeground="white",command=deletestudent)
deletebtn.pack(side=TOP,expand=True)

updatebtn = Button(DataEntryFrame,text='4. Update student',width=20,font=('chikker',20,'bold'),bd=6,bg='skyblue3',activebackground="blue",relief=RIDGE,activeforeground="white",command=updatestudent)
updatebtn.pack(side=TOP,expand=True)

showbtn = Button(DataEntryFrame,text='5. Show All',width=20,font=('chikker',20,'bold'),bd=6,bg='skyblue3',activebackground="blue",relief=RIDGE,activeforeground="white",command=showstudent)
showbtn.pack(side=TOP,expand=True)

exportbtn = Button(DataEntryFrame,text='6. Export data',width=20,font=('chikker',20,'bold'),bd=6,bg='skyblue3',activebackground="blue",relief=RIDGE,activeforeground="white",command=exportstudent)
exportbtn.pack(side=TOP,expand=True)

exitbtn = Button(DataEntryFrame,text='7. Exit',width=20,font=('chikker',20,'bold'),bd=6,bg='skyblue3',activebackground="blue",relief=RIDGE,activeforeground="white",command=exitstudent)
